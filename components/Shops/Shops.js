...
const Shops = () => {
    const sampleData = [
        ...
        },
        {
            id: 2,
            name: "Daya Clinic",
            doctor: {1:{name: "Dr Reshma", Specialisation: "MBBS"},2:{name: "Dr Reshma", Specialisation: "MBBS"}},
            location: "Kalarivadhikal junction, Kottakal puram",
            description: "asd",
            Name : "Meghna",
            Timings:"Timings: 9:00-1:00 and 3:00-9:00",
            Fee : "Fee: Rs.60",
            Appointment_no: "Appointment_no: 9947821706",
            image: "https://i.imgur.com/LfkrbMr.jpeg"
        },
        {
            id: 3,
            name: "Dr K Bright",
            location: "Amrita Ayurveda School Rd, Vallikavu, Kerala 690546",
