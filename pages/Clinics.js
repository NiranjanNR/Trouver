            ...
            <div className='xl:flex justify-center'>
              <div className='flex items-center justify-center'>
                <div className='mt-24 xl:mr-36 '>
                  ...
                  <div className='flex justify-center xl:justify-start'><button className=' buttonmod text-lg text-white hover:bg-sky-400 font-semibold px-8 py-4 rounded-lg '>Goal of Our Project</button></div>
                </div>
              </div>
